...
# Notice
This framework has been used on the linux version of <a href="www.cubebackup.com"> CubeBackup for Google Apps</a>, which is a local backup solution for Google Apps data. 
